...
public class CustomerController {
    private CustomerPanel entityPanel;
    private CustomerDAO entityDAO;
    
    private CustomerTableModel entityTableModel;
    private CustomerDetailsController entityDetailsController;
    ...
    public CustomerController(CustomerPanel view) throws DAOException {
        DAOManager DAOManager = new DAOManager();
        
        /*** Specific dao manager ***/
        this.entityDAO = DAOManager.getDAOinstance().getCustomerDAO();
        
        /*** Specific details controller ***/
        this.entityDetailsController = new CustomerDetailsController(
                view.getDetailsPanel(),
                DAOManager.getDAOinstance().getCardTypeDAO()
        );
        
        /*** Specific table model ***/
        this.entityTableModel = new CustomerTableModel(this.entityDAO);
    ...
    public void initEvents() {
        ...
        btnEdit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {  
                try {
                    Customer entity = getRowSelected();
    ...
    private Customer getRowSelected() throws DAOException {
