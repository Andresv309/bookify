...
public class ShelveController {
    private ShelvePanel entityPanel;
    private ShelveDAO entityDAO;
    
    private ShelveTableModel entityTableModel;
    private ShelveDetailsController entityDetailsController;
    ...
    public ShelveController(ShelvePanel view) throws DAOException {
        DAOManager DAOManager = new DAOManager();
        
        /*** Specific dao manager ***/
        this.entityDAO = DAOManager.getDAOinstance().getShelveDAO();
        
        /*** Specific details controller ***/
        this.entityDetailsController = new ShelveDetailsController(view.getDetailsPanel());
        
        /*** Specific table model ***/
        this.entityTableModel = new ShelveTableModel(this.entityDAO);
        ...
        btnEdit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {  
                try {
                    ...
                    Logger.getLogger(ShelveController.class.getName()).log(Level.SEVERE, null, ex);
                } 
            }
        });
        ...
        btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {  
                try {
                    ...
                    Shelve entity = entityDetailsController.getEntity();
    ...
    private Shelve getRowSelected() throws DAOException {
