...
import app.controllers.category.CategoryController;
...
public class CategoryPanel extends Form {
    ...
    public CategoryPanel() throws DAOException {
        initComponents();
    ...
    public CategoryDetailsPanel getDetailsPanel() {
        return detailsPanel;
    }
    ...
    private app.views.category.CategoryDetailsPanel detailsPanel;
