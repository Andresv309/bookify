...
import app.controllers.stock.StockController;
...
public class StockPanel extends Form {

    public StockPanel() throws DAOException {
        initComponents();
    ...
    public StockDetailsPanel getDetailsPanel() {
        return detailsPanel;
    }
    ...
    private void initComponents() {
        ...
        detailsPanel = new app.views.stock.StockDetailsPanel();
    ...
    private app.views.stock.StockDetailsPanel detailsPanel;
