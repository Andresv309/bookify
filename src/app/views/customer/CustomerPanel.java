...
public class CustomerPanel extends Form {

    public CustomerPanel() throws DAOException {
        initComponents();
    ...
    private void initComponents() {
        ...
        detailsPanel = new app.views.customer.CustomerDetailsPanel();
        ...
        jLabel2.setText("Clientes de la");
    ...
    private app.views.customer.CustomerDetailsPanel detailsPanel;
