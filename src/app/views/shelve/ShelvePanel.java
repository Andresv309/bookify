...
import app.controllers.shelve.ShelveController;
...
public class ShelvePanel extends Form {

    public ShelvePanel() throws DAOException {
        initComponents();
        table.fixTable(jScrollPaneTable);
        new ShelveController(this);
    ...
    public ShelveDetailsPanel getDetailsPanel() {
        return detailsPanel;
    }
    ...
    private void initComponents() {
        ...
        detailsPanel = new app.views.shelve.ShelveDetailsPanel();
        ...
        jLabel2.setText("Estanterías de");
    ...
    private app.views.shelve.ShelveDetailsPanel detailsPanel;
