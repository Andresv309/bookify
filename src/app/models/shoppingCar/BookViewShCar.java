...
public class BookViewShCar extends javax.swing.JPanel {

    public BookViewShCar() {
        initComponents();
    }
    
    
    public BookViewShCar(String imgName) {
        initComponents();
        String path = System.getProperty("user.dir") +
                            "\\src\\Images\\portadas\\" +
                            imgName;
       bookPortrait.setIcon(new javax.swing.ImageIcon(path));
...
//    
    ...
    private void initComponents() {
        ...
        add(bookPortrait, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, -1, 229));
